...
// Copyright (c) 2013 The Monkeycoin developers
...
uint256 hashGenesisBlock("0x000009643f6d4db88cfb823224c96563f1e7197cc5333c40c6029a11741afcac");
static const unsigned int timeGenesisBlock = 1392081929;
...
const string strMessageMagic = "Monkeycoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    if (nHeight <= 999)
    {
        return 200 * COIN;//just for testing!
    }
...
//                           (pindex->nHeight==91880 && pindex->GetBlockHash() == uint256("0x00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721")));
    ...
    if (vtx[0].GetValueOut() > GetBlockValue(pindex->nHeight, nFees, pindex->nBits) && pindex->nHeight > 999)
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "2014-02-11 monkeycoin begin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x7fcbc53b4611a8b4f49d12cdfda64d25833b71e5bd4f37302d8c7dc5b20cb728"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MonkeycoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MonkeycoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MonkeycoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("monkeycoin-miner");
    ...
    try { loop {
        ...
        printf("Running MonkeycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("MonkeycoinMiner terminated\n");
        throw;
    }
}
