...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click monkey: links)
...
{
    // clicking on monkey: URLs creates FileOpen events on the Mac:
